...
{
    /// <summary>
    /// Validates branch master data before insert and update operations.
    /// </summary>
    public class BranchValidator : AbstractValidator<Branch>
    {
        public BranchValidator()
        {
            // Logic: Branch code is used as shard filter and must stay compact and uppercase-friendly.
            RuleFor(x => x.MACN)
            ...
            // Logic: Phone is optional, but when provided it must follow local phone format.
            RuleFor(x => x.SODT)
