...
namespace BankDds.Core.Validators
{
    ...
    {
        public UserValidator(IBranchRepository branchRepository)
        {
            ...
            RuleFor(x => x.DefaultBranch)
                ...
                .MustAsync((branchCode, ct) => branchRepository.BranchExistsAsync(branchCode))
                .WithMessage("Chi nhánh mặc định không tồn tại trong hệ thống.");
