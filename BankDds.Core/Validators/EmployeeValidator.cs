...
{
    /// <summary>
    /// Validates employee input for branch operations and role mapping.
    /// </summary>
    public class EmployeeValidator : AbstractValidator<Models.Employee>
    {
        ...
        {
            // Logic: Employee code is used as identity mapping for ChiNhanh and NganHang login accounts.
            RuleFor(x => x.MANV)
            ...
            // Logic: Employee must always be assigned to a valid branch for data ownership and authorization.
            RuleFor(x => x.MACN)
