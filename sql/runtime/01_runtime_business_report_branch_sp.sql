USE NGANHANG_PUB;
GO
-- Runtime-only SP package (UI-first).
-- Source-of-truth for business/report/branch procedures and view_DanhSachPhanManh.
-- Excludes infrastructure setup and excludes deprecated SP_CreateTransferTransaction.
-- User CRUD procedures are moved to transitional file for Phase D refactor.
GO
...
IF OBJECT_ID(N'dbo.SP_CrossBranchTransfer', N'P') IS NOT NULL
    PRINT N'>>> Đã tạo nhóm thủ tục Giao dịch (7 SP).';
ELSE
