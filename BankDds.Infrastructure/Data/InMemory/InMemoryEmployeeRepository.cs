...
public class InMemoryEmployeeRepository : IEmployeeRepository
{
    ...
    {
        new Employee { MANV = "NV00000001", HO = "Nguyen", TEN = "Admin",   DIACHI = "123 Admin St",    CMND = "0011111111", PHAI = "Nam", SODT = "0911111111", MACN = "BENTHANH", TrangThaiXoa = 0 },
        new Employee { MANV = "NV00000002", HO = "Tran",   TEN = "Manager", DIACHI = "456 Manager Ave", CMND = "0022222222", PHAI = "Nam", SODT = "0922222222", MACN = "BENTHANH", TrangThaiXoa = 0 },
        new Employee { MANV = "NV00000003", HO = "Le",     TEN = "Teller",  DIACHI = "789 Teller Rd",   CMND = "0033333333", PHAI = "Nữ", SODT = "0933333333", MACN = "TANDINH",  TrangThaiXoa = 0 },
        new Employee { MANV = "NV00000004", HO = "Pham",   TEN = "Staff",   DIACHI = "321 Staff Blvd",  CMND = "0044444444", PHAI = "Nữ", SODT = "0944444444", MACN = "TANDINH",  TrangThaiXoa = 0 }
    };
